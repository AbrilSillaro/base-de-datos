...
namespace CapaDeNegocio
{
    ...
    {   
        internal Singleton S { get => Singleton.GetInstance; } // se obtiene la instancia sinlgeton de la clase singleton
        #region IID
        ...
        public void Add()
        {
            S.ISU.Add(this); // S es la instancia. se da un encapsulamiento ya que se accede a un singleton
        }
        public void Erase()
        {
            S.ISU.Erase(this);
